 ...
 */
export function composeToLatex(expr) {
  let s = expr.trim();
 ...
 */
export function fractionToLatex(numerator, denominator) {
 ...
 */
export function matrixToLatex(rows, delimiters = 'parentheses') {
  const envMap = {
 ...
 */
export function casesToLatex(rows) {
  const body = rows.map(r => {
 ...
 */
export function alignToLatex(lines) {
 ...
 */
export function renderToHTML(nodes, opts = {}) {
...
export function mount(source, element, opts = {}) {
